...
const CAMERA_INITIAL_POSITION_MOBILE = new THREE.Vector3(0, 0, 9)
...
export const CameraControls: React.FC = () => {
  ...
  useEffect(() => {
    ...
    controls.object.position.copy(isMobile ? CAMERA_INITIAL_POSITION_MOBILE : CAMERA_INITIAL_POSITION)
