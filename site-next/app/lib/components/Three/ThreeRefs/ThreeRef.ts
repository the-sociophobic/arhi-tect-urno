...
// Three.js объекты часто обновляются. Если на каждое обновление вызывать React.setState,
// будет очень выская нагрузка. Гораздо эффективней использовать референсы и лисенеры
